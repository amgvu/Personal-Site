      ...
      <main className="bg-[#080808] px-4 md:px-8 lg:px-16 xl:px-24">
        <section className="flex min-h-screen flex-grow flex-col place-content-center">
          ...
          <div className="relative font-sans bottom-20 flex flex-grow flex-col place-content-center p-10 py-10">
            ...
            <h3 className="py-2 text-2xl text-gray-400 animate__fadeIn animate__delay animate__animated md:text-5xl">
              Full Stack Developer
            </h3>
            <p className="text-md max-w-xl py-5 leading-8 text-gray-200 animate__fadeIn animate__delay-1s animate__animated dark:text-gray-200 md:text-xl">
            ...
            <div className="animate__fadeIn animate__delay-1s animate__animated">
              {socialIcons.map((item, index) => (
                <button key={index} className="delay-10 flex-row gap-16 bg-transparent p-3 py-3 text-5xl text-gray-100 transition duration-100 ease-in-out hover:-translate-y-1 hover:scale-110 dark:text-gray-400" onClick={() => window.open(item.link)}>
                  <item.icon />
                </button>
              ))}
            </div>
